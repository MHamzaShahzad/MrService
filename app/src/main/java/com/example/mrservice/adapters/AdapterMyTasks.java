...
public class AdapterMyTasks extends RecyclerView.Adapter<AdapterMyTasks.Holder> {
    ...
    public AdapterMyTasks(Context context, List<TaskModel> list) {
    ...
    @NonNull
    @Override
    public AdapterMyTasks.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_all_tasks, null);
        return new Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterMyTasks.Holder holder, int position) {
